...
class annihilating_halos_model(model):
	def __init__(self,ref_el_spec,ref_ph_spec,ref_oth_spec,m,zh,fh,cut,ns,logEnergies=None,redshift=None, **DarkOptions):
		...
		### H2S
		#
		# HALOS TO SMOOTH NORMALIZATION (corresponds to slatyer 1211.0283, etc) --> NO factor of the boost in denominator of f(z)
		# injected energy rate, (dEdV/dt)_inj,smooth, does NOT include the boost (line 1749 of thermodynamics.c)
		#
		###
		# leave this blank
		...
		### H2H
		#
		# HALOS TO HALOS NORMALIZATION (exoclass as intended; corresponds to poulin 1508.01370) --> uncomment line below
		# injected energy rate, (dEdV/dt)_inj,halos, includes a boost factor (line 1749 of thermodynamics.c)
		#
		###
